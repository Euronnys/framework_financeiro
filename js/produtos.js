  ...
  produtosCarrinho.forEach(produto => {
    ...
    if(row != null){
     linha += "<tr>"+
              ...
              "<td id='tdqtde'>"+produto.quantidade+"<select id='qtdeCarrinho' onBlur='atualizarqtdeCarrinho("+produto.id_produto+",this.value)'><option value='1'>1</option><option value='2'>2</option> </select> <button class='btn btn-outline-success'><i class='fa fa-plus'></i></button></td>"+
